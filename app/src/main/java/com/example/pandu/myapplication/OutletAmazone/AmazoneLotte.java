...
public class AmazoneLotte extends AppCompatActivity {

    CarouselView carouselView;

    int[] images = {R.drawable.lotte2, R.drawable.lotte3, R.drawable.lotte4, R.drawable.lotte5};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_amazone_lotte);
        ...
        lokasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(AmazoneLotte.this, MapsAmazoneLotte.class);
                startActivity(i);
            }
        });
